    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
            <div style="width:90%; margin-left: auto; margin-right:auto;">
                    ...
                    <tbody>
                        @foreach($produtos as $produto)
                            <tr>
                                ...
                                <td>{{$produto->item_detalhe->comprimento ?? ""}}</td>
                                <td>{{$produto->item_detalhe->altura ?? ""}}</td>
                                <td>{{$produto->item_detalhe->largura ?? ""}}</td>
                ...
                <br>
                {{$produtos->lastItem()}} - Número do último elemento da página
            </div>
        </div>
    </div>
